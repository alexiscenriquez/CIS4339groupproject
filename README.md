...
### 2.1 For Local Deployments
 ...
 1) Create a .env file containing the DATABASE_URL string
...
NOTE: Create all Posts of Clients, Employees, Events, Services and Volunteers before using DELETE, GET, and POST statements.
