            ...
            <table class="table table-light table-hover caption-top">
                ...
                <tbody>
                    ...
                    <tr v-for="s in service" :key="s.vid">
                        ...
                        <td><router-link :to="{name: 'services_edit', params: { id: s.sid }}" class="btn btn-secondary ">Change Org</router-link></td>
            ...
            <table class="table table-light table-hover caption-top">
                ...
                <tbody>
                    ...
                    <tr v-for="ev in event" :key="ev.evid">
                        ...
                        <td><router-link :to="{name: 'events_edit', params: { id: ev.evid }}" class="btn btn-secondary ">Change Org</router-link></td>
                    </tr> 
                </tbody>
            </table>
        </div>
